...
import { getLanguageModes, TextDocument, CompletionItemKind, ClientCapabilities, TextEdit } from '../modes/languageModes.js';
...
export async function testCompletionFor(value, expected, uri = testUri, workspaceFolders) {
