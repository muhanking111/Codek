...
const configSuggestions = [
    ...
    {
        name: "http.proxy",
        description: "Override the HTTP proxy, normally configured using the 'http_proxy', 'https_proxy', and 'all_proxy' environment variables (see `curl(1)`). See gitcredentials[7] for proxy authentication details. This can be overridden on a per-remote basis; see remote.<name>.proxy",
    },
    {
