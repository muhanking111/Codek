...
async function suggestNativePreview(context, experimentationService) {
    ...
    if (vscode.extensions.getExtension(useTsgo_1.tsNativeExtensionId)) {
    ...
    if (selection === install) {
        await vscode.commands.executeCommand('workbench.extensions.installExtension', useTsgo_1.tsNativeExtensionId);
    }
